...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2025 at 08:44 AM
...
INSERT INTO `orders` (`order_id`, `customer_id`, `driver_id`, `pickup_address`, `delivery_address`, `total_amount`, `payment_method`, `status`, `description`, `created_at`, `updated_at`, `order_type`, `length`, `weight`) VALUES
(6, 5, NULL, '', 'abou samra', 240.00, 'cash', 'pending', '', '2025-05-06 23:11:10', '2025-05-06 23:11:10', 'simple', NULL, NULL),
(7, 5, NULL, '', 'Al_mina ', 120.00, 'cash', 'pending', '', '2025-05-07 22:44:03', '2025-05-07 22:44:03', 'simple', NULL, NULL),
(8, 5, NULL, '', 'tripploi _ 200', 120.00, 'cash', 'pending', '', '2025-05-07 23:51:27', '2025-05-07 23:51:27', 'simple', NULL, NULL),
(9, 8, NULL, '', 'tripoli abou samra', 220.00, 'cash', 'pending', '', '2025-05-09 22:43:00', '2025-05-09 22:43:00', 'simple', NULL, NULL);
...
--
ALTER TABLE `wallets`
  MODIFY `wallet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
